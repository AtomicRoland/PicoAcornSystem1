/*
6502 Emulator
Based on https://codegolf.stackexchange.com/questions/12844/emulate-a-mos-6502-cpu/13020#13020

Credits to Mike Chambers
*/
...
void write6502(uint16_t address, uint8_t value) {
    if (address < 0XFE00) {     // the monitor is write protected
